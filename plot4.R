...
plot(data_in_use$Global_active_power,col="black",xlab="",ylab="Global Active Power (Kilowatts)",type = "l")

plot(data_in_use$Voltage,col="black",ylab="Voltage",type="l",xlab="datetime")
...
plot(data_in_use$Global_reactive_power,col="black",ylab="Global_reactive_power",type="l",xlab="datetime")
